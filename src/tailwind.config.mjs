    ...
    theme: {
        extend: {
            fontSize: {
                ...
                '2xl': ['1.5rem', { lineHeight: '1.3', letterSpacing: '0em', fontWeight: '700' }],
                '3xl': ['1.875rem', { lineHeight: '1.2', letterSpacing: '-0.01em', fontWeight: '700' }],
                '4xl': ['2.25rem', { lineHeight: '1.1', letterSpacing: '-0.02em', fontWeight: '800' }],
                '5xl': ['3rem', { lineHeight: '1.1', letterSpacing: '-0.03em', fontWeight: '900' }],
                '6xl': ['3.75rem', { lineHeight: '1', letterSpacing: '-0.04em', fontWeight: '900' }],
